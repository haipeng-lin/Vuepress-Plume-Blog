...
export default defineNavbarConfig([
    ...
    { text: '博客', link: '/blog/archives/', icon: 'material-symbols:article' },
    {
        ...
        items: [
            ...
            { text: '中间件', link: '/middleware/message-queue/', icon: 'oui:nav-service-map' },
            { text: '微服务', link: '/cloud/', icon: 'ri-cloud-line' },
            { text: 'AI', link: '/AI/LangChain4j/', icon: 'ri:ai' },
            { text: '计算机基础', link: '/computer-basics/', icon: 'ic:outline-computer' },
        ],
    },
    {
        text: '记录',
        ...
        items: [
            ...
            { text: '藏宝阁', link: '/movie/', icon: 'material-symbols:movie-info-rounded' },
    ...
    },
    {
        ...
        items: [
            { text: '项目管控流式平台', link: '/project/project-stream/', icon: 'ant-design:project-filled' },
            { text: '知识交流平台', link: '/project/knowledge-stream/', icon: 'fluent:stream-20-filled' },
        ],
    },
    { text: '关于', link: '/about-me/', icon: 'material-symbols-light:id-card-rounded' },
])