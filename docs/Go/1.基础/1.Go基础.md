...
|              | 关键字                                                       | 描述                                                         | 使用举例                                   |
| ------------ | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------ |
| **整形**     | uint8（byte）<br />uint16（short）<br />uint32<br />uint64（long） | **无符号整型**<br />8位、0-255<br />16位、0-65535<br />32位<br />64位 |                                            |
|              | int8<br />int16<br />int32<br />int64                        | **有符号整型**<br />8位、-128-127<br />16位、-32768-32767<br />32位<br />64位 |                                            |
...
| **复数**     | complex64                                                    | 32位实部，32位虚部<br />                                     | var c1 complex64 = complex(5, 6) // 5 + 6i |
